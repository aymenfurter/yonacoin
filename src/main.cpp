...
uint256 hashGenesisBlock("0xbd8b7eaf912b1dcbd55b70473c5e87ee1866b7cc1e35405ecb27341c029d33b6");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // yonacoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "yonacoin Signed Message:\n";
...
{
    // yonacoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // yonacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // yonacoin: 3.5 days
static const int64 nTargetSpacing = 150; // yonacoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // yonacoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // yonacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // yonacoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7706d2b75a1fd5fcec04e1de8a696119328542457dc0419b644fac35ec058ad8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("1e877e55a60ccef2229cad1cca9474078072c9825245b1b8073db34f61a2a7fbdd53e02f8e4b2ec6ea76c5d78649f8f2bdbfac211a9f62edff2a60e5cdda300bd8") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1514661846;
        block.nBits    = 504365644;
        block.nNonce   = 2923784942;

        if (fTestNet)
        {
            block.nTime    = 1514661846;
            block.nNonce   = 4022863455;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5ef29db90f29f60ed3cd5a4083fb2906c3616852fbfd721a17ea288081b21561"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // yonacoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("yonacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("yonacoinMiner : ProcessBlock, block not accepted");
    }
